...
Fresh matched requests completed 100/100 episodes per arm with zero request
failures:

- Control `crewborg-solver-crowd-cap:v1`:
  `xreq_d78dd583-96cd-4e83-8dc0-beeb0f3a343c`
- Candidate `crewborg-solver-early-public:v1`:
  `xreq_14f0ddf0-2fba-444b-8d22-0c5a0ab04f4a`

The mechanism was live but sparse. The exact early line fired in three
meetings, always at offset 241; all three targets were impostors and all three
were ejected. One line preceded two teammate target ballots, one arrived after
the target already had three, and one split the remaining response one before
and one after. Self-defense fired nine times in five games, and crewborg was
not ejected in any of those games.

Directionally, team crew-target ballots fell from 1.40 to 1.13 per game and
crew ejections from 0.21 to 0.14, while impostor-target ballots rose from 2.11
to 2.37 and impostor ejections from 0.12 to 0.13. None of those deltas was
individually significant. Crew wins were 44/100 control versus 40/100 candidate
(`p=0.67`), also unresolved.

The implementation therefore demonstrated precise coordination without enough
coverage to estimate a win effect. The next iteration should carry conclusions
across meetings and update the joint posterior when a new kill proves another
player was crew, while retaining the tick-240 recomputation and chat-only
boundary.
